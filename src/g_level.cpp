...
void FLevelLocals::Init()
{
	...
	songid = info->songid;  //[XANE]Which song ID to play at the beginning of this level. (not to be confused with
	                          //"Music" and "musicorder", ZDoom's built-in MAPINFO properties.
